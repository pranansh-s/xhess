import { KNIGHT_DIRECTIONS } from '../../constants/index.js';
...
export const KnightStrategy: PieceMovementStrategy = {
  getValidMoves(board: Board, piece: Piece, player: Color, moves: Move[]): Position[] {
    return getMovesAlongDirection(board, piece.pos, player, KNIGHT_DIRECTIONS, 1);
  },
};
